    ...
    <div className="container py-16">
      <div className="mx-auto max-w-xl space-y-8 rounded-[32px] border border-white/10 bg-slate-950/80 p-10 shadow-glow">
        <div className="space-y-3">
          <p className="text-sm uppercase tracking-[0.24em] text-violet-300">Account access</p>
          <h1 className="text-3xl font-semibold text-white">Sign in to DropHub</h1>
          <p className="text-slate-400">Use email or Google to continue. Your progress, rewards, and campaign data are saved in Firebase.</p>
        </div>
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="space-y-3">
            ...
            <Input value={password} onChange={(event) => setPassword(event.target.value)} placeholder="Enter password" type="password" required />
          </div>
